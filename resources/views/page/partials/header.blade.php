...
<div class="fixed-top fixed-top-sm">
    ...
    <div class="container-fluid d-md-block d-none" style="background-color: #444444">
        <div class="row">
            <div class="container text-white">
                <div class="d-flex justify-content-end align-items-center">
                    <p class="m-0 p-0"><a href="{{ asset($contacto->text{'contacto'} ?? '') }}" target="_blank" class="text-decoration-none border-right px-3 text-white">FORMULARIO DE INSCRIPCIÒN</a></p>
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown d-flex justify-content-center align-items-center" style="border-right: 1px solid #71A7DE">
                        <a class="nav-link py-0 px-4 {{ request()->is('quienes-somos') ? 'active' : null }} {{ request()->is('enlaces') ? 'active' : null }} {{ request()->is('mision-vision') ? 'active' : null }} {{ request()->is('objetivos') ? 'active' : null }} {{ request()->is('autoridades') ? 'active' : null }}"  id="navbarDropdownMenuLink"
                    ...
                    <li class="nav-item dropdown d-flex justify-content-center align-items-center"  style="border-right: 1px solid #71A7DE">
                        <a class="nav-link  py-0 px-4 {{ request()->is('nuestra-sede') ? 'active' : null }} {{ request()->is('asesorias') ? 'active' : null }}"  id="navbarDropdownMenuLink"
                    ...
                    <li class="nav-item dropdown d-flex justify-content-center align-items-center"  style="border-right: 1px solid #71A7DE">
                        <a class="nav-link py-0 px-4 {{ request()->is('uom*') ? 'active' : null }} {{ request()->is('asimra*') ? 'active' : null }}" id="navbarDropdownMenuLink"
                    ...
                    <li class="nav-item d-flex justify-content-center align-items-center"  style="border-right: 1px solid #71A7DE">
                        <a class="nav-link py-0 px-4 {{ request()->is('prensa*') ? 'active' : null }}" href="{{ route('prensa') }}">PRENSA</a>
                    </li>
                    <li class="nav-item dropdown d-flex justify-content-center align-items-center"  style="border-right: 1px solid #71A7DE">
                        <a class="nav-link py-0 px-4  {{ request()->is('cursos') ? 'active' : null }} {{ request()->is('otros') ? 'active' : null }}" id="navbarDropdownMenuLink"
                           aria-haspopup="false" aria-expanded="false">CURSOS</a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ route('cursos') }}">CAMIMA</a>
                            <a class="dropdown-item" href="{{ route('otros') }}">EMPRESA</a>
                        </div>
                    </li>
                    <li class="nav-item d-flex justify-content-center d-lg-none align-items-center"  style="border-right: 1px solid #71A7DE">
                        <a class="nav-link py-0 px-4 {{ request()->is('contacto') ? 'active' : null }}" href="{{ route('contacto') }}">CONTACTO</a>
                    </li>
                </ul>
                <!-- Links -->
