            ...
            <div class="col-md-6">
                <div class="bg-white p-5 rounded">
                    <div class="text-center">
                        <img src="{{ asset($logos->text{'header'} ?? 'http://camima.org.ar/imagenes/iconos/logo.png') }}" alt="" class="img-fluid">
                    </div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group text-right">
                            <button type="submit" class="btn text-white" style="background-color: #133165">
                                Ingresar
                            </button>
