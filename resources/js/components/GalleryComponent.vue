        ...
        <fieldset>
            ...
            <draggable v-model="gallery" class="row" draggable=".item" @change="log">
                <div class="col-md-4 mb-2 item" v-for="(item,index) in gallery" :key="index" >
                    ...
                    <div class="" v-if="section == 'autoridades'">
                    ...
                    <div class="" v-if="section == 'interes'">
                        ...
                        <div class="md-form m-0">
                            <input type="text" :name="'gallery['+index+'][link]'" :value="item.link" placeholder="Link" class="form-control">
                        </div>
                    </div>
                    <div class="" v-if="section == 'nuestrasede' || section == 'asesorias'">
                        <div class="md-form m-0" >
                            <input type="text" :name="'gallery['+index+'][title_es]'" :value="item.title_es"  placeholder="Titulo" class="form-control">
                        </div>
                    </div>
